      ...
      <div className="modal modal--wide" role="dialog" aria-modal="true">
        <div className="modal-header">
          ...
          <div className="modal-header-actions">
            <button
              className={`btn-generate ${reevaluating ? 'loading' : ''}`}
              onClick={onReevaluate}
              disabled={reevaluating}
            >
              {reevaluating ? (
                <><span className="spinner" />Re-evaluating…</>
              ) : (
                'Re-evaluate'
              )}
            </button>
        ...
        <div className="modal-body">
          {reevaluating && (
            <p className="modal-loading-note">
              <span className="spinner" />Refreshing recommendation...
            </p>
          )}
