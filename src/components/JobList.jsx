...
export default function JobList({ jobs, model, evaluationResults, setEvaluationResults }) {
  ...
  const handleRegenerateFromModal = async (job) => {
    ...
    <div className="job-list">
      ...
      {modalJob && evaluationResults[modalJob.id] && (
        <EvaluationModal
          ...
          model={model}
          regenerating={regeneratingId === modalJob.id}
          regenerateError={errors[modalJob.id]}
          onRegenerate={() => handleRegenerateFromModal(modalJob)}
